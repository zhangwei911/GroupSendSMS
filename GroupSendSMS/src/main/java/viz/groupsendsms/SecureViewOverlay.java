...
/**
 * This view is part of the {@link GroupSendActivity} demonstration activity.
 *
...
public class SecureViewOverlay extends ViewGroup {
    private GroupSendActivity mActivity;

    public SecureViewOverlay(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public void setActivityToSpoof(GroupSendActivity activity) {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        spoofLayout(findViewById(R.id.overlay_button1),
                mActivity.findViewById(R.id.send_enter));
    }
